...
export class TcfEuV2 extends AbstractEncodableSegmentedBitStringSection {
    ...
    static VERSION = 2;
    static NAME = "tcfeuv2";
    base64UrlEncoder = new TraditionalBase64UrlEncoder();
    constructor(encodedString) {
        ...
        fields.set(TcfEuV2Field.SPECIAL_FEATURE_OPTINS.toString(), new EncodableFixedBitfield([false, false, false, false, false, false, false, false, false, false, false, false]));
        fields.set(TcfEuV2Field.PURPOSE_CONSENTS.toString(), new EncodableFixedBitfield([
            false,
            false,
            false,
            false,
        ...
        fields.set(TcfEuV2Field.PURPOSE_LEGITIMATE_INTERESTS.toString(), new EncodableFixedBitfield([
            false,
            false,
            false,
            false,
        ...
        fields.set(TcfEuV2Field.PUBLISHER_CONSENTS.toString(), new EncodableFixedBitfield([
            false,
            false,
            false,
            false,
        ...
        fields.set(TcfEuV2Field.PUBLISHER_LEGITIMATE_INTERESTS.toString(), new EncodableFixedBitfield([
            false,
            false,
            false,
            false,
        ...
        fields.set(TcfEuV2Field.PUBLISHER_CUSTOM_CONSENTS.toString(), new EncodableFlexibleBitfield(() => {
            return numCustomPurposes.getValue();
        }, []));
        fields.set(TcfEuV2Field.PUBLISHER_CUSTOM_LEGITIMATE_INTERESTS.toString(), new EncodableFlexibleBitfield(() => {
            return numCustomPurposes.getValue();
        }, []));
