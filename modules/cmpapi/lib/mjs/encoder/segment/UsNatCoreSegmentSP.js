...
export class UsNatCoreSegment extends UsNatCoreSegmentBase {
    base64UrlEncoderSP = CompressedBase64UrlEncoder.getInstance();
    bitStringEncoderSP = BitStringEncoder.getInstance();
    constructor(encodedString, version) {
        super();
        if (encodedString) {
    ...
    decodeSegment(encodedString, fields) {
        ...
        try {
            let bitString = this.base64UrlEncoderSP.decode(encodedString);
