...
import { UsNat } from "../../../src/encoder/section/UsNatSP";

describe("manifest.section.UsNatSP", (): void => {
  it("(v1) should encode default to BAAAAAAAAQA.QA", (): void => {
    let usNat = new UsNat(undefined, 1);
    expect(usNat.encode()).to.eql("BAAAAAAAAQA.QA");
  });

  it("(v1) should encode to BVVVkkkklWA.YA", (): void => {
    let usNat = new UsNat(undefined, 1);
  ...
  it("(v1) should encode default to BAAAAAAAAQA", (): void => {
    let usNat = new UsNat(undefined, 1);
  ...
  it("(v1) should decode BVVVkkkklWA.YA", (): void => {
  ...
  it("(v1) should decode BbbbGxsbFbA.YA", (): void => {
